	...
	<div id="homecontentbg">
		...
		<div id="slideshow">
			<div class="carouselimage">
				<a href="projects/project1.html"><img src="style/project1img1.png" alt="cool doggo" height=455 width=750></a>
			</div>
			<div class="carouselimage">
				<a href="projects/project2.html"><img src="style/levelshome.gif" alt="cool doggo" height=455 width=750></a>
			</div>
			<div class="carouselimage">
				<a href="projects/project3.html"><img src="style/fantasysample.gif" alt="cool doggo" height=455 width=750></a>
			</div>
			<div class="carouselimage">
				<a href="projects/project4.html"><img src="style/matchasocial.gif" alt="cool doggo" height=455 width=750></a>
			</div>
		</div>
		</div>
	</div>
